...
<div class="register-container">
    ...
    <g:form controller="auth" action="registerSubmit">
        ...
        <g:submitButton name="register" value="Registrarse" class="button"/>
    </g:form>

    <p style="text-align: center;">¿Ya tienes cuenta? <g:link controller="auth" action="login">Inicia sesión</g:link></p>
</div>
</body>
</html>
